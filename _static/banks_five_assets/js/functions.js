...
document.getElementById('asset_c').onkeyup = function () {
    findTotal();
    if($.trim($(this).val()) === "") {
        $(this).val("0");
    }
...
document.getElementById('asset_d').onkeyup = function () {
    findTotal();
    if($.trim($(this).val()) === "") {
        $(this).val("0");
    }
...
document.getElementById('asset_e').onkeyup = function () {
    findTotal();
    if($.trim($(this).val()) === "") {
        $(this).val("0");
    }
...
// c_set field values to two decimal places
